...
前提：Chrome 已加载新 zip（v3.4.0），或加载已解压目录 `extension/`。
...
- Chrome 实际加载目录确认是仓库 `extension/`，扩展从 v3.1.1 重载到 v3.5.0；manifest errors、runtime errors、runtime warnings 均为 0。
