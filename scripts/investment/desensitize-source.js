...
import "../../extension/source-capture.js";
import "../../extension/public-fund-metadata.js";
...
const outputPath =
  process.argv[3] || path.join(root, "data/snapshots/investment/eastmoney-source-desensitized.json");

if (!inputPath) {
  console.error(
    "用法: node scripts/investment/desensitize-source.js <真实采集包路径> [输出路径]",
  );
