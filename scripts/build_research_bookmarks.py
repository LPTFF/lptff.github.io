...
def main() -> int:
    ...
    parser.add_argument("--output-json", type=Path, default=Path("public/data/research-bookmarks.json"))
    parser.add_argument("--output-markdown", type=Path, default=Path("public/data/research-bookmarks.md"))
