...
from crawl.douban import poster_data_url, publish as publish_douban
from crawl.githubTrending import parse_trending
from crawl.infzm import parse_response as parse_infzm
from crawl.juejin import parse_response as parse_juejin
from crawl.kuaishou import parse_response as parse_kuaishou
from crawl.leetCode import (
    build_item,
    normalize_legacy_item,
    publish_release,
    validate_existing_release,
)
from crawl.meituanTech import parse_feed
from crawl.sendNotify import send_notification
from crawl.v2ex import collect as collect_v2ex, parse_response as parse_v2ex
from crawl.weibo import parse_response as parse_weibo
from crawl.welfare import hxm5_request_body, parse_hxm5_response
from crawl.lib.welfare_sources import (
    parse_0818_rss,
    run_0818_source,
    parse_daydayzhuan,
...
from crawl.run_collectors import is_fresh_candidate, select_collectors
from crawl.tiktokData import collect as collect_tiktok
from crawl.zhipin import parse_public_page as parse_zhipin_public_page
...
class ParserTests(unittest.TestCase):
    ...
    def test_0818_top_skip_does_not_delete_preserved_contract(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "crawl.lib.welfare_sources.preserve_or_fail",
                return_value=result,
            ) as preserve:
                self.assertEqual(
...
class ReleaseAndNotificationTests(unittest.TestCase):
    ...
    @patch("crawl.tiktokData.webdriver.Chrome")
    ...
    @patch("crawl.sendNotify.requests.post")
