<template>
  <div class="fund-layout">
    <el-menu :default-active="activeIndex" mode="horizontal" router class="fund-menu">
      <el-menu-item index="/investment/legacy">资产总览</el-menu-item>
      <el-menu-item index="/investment/legacy/holding">持仓明细</el-menu-item>
      <el-menu-item index="/investment/legacy/performance">收益分析</el-menu-item>
      <el-menu-item index="/investment/legacy/transaction">交易流水</el-menu-item>
      <el-menu-item index="/investment/legacy/review">投资复盘</el-menu-item>
      <el-menu-item index="/investment/legacy/import">导入数据</el-menu-item>
      <el-menu-item index="/investment">返回新版 Investment OS</el-menu-item>
    </el-menu>
...
function onSynced() {
  refresh();
  if (route.path === "/investment/legacy/import") {
    router.push("/investment/legacy");
  }
}
